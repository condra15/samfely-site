    ...
    <nav className="navbar">
      <div className="navbar-inner container">
        ...
        <div className={`navbar-links ${menuOpen ? 'show' : ''}`}>
          ...
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSfqaDDM6_VE82kpKdMeB6MzzeosbjTRSxlKp6bc7NaPeMVHNg/viewform" className="navbar-cta" target="_blank" rel="noopener noreferrer">Enroll now</a>
        </div>
      </div>
    </nav>
  );

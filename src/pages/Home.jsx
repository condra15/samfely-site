...
export default function Home() {
  const faqs = [
    ...
    { question: "What does a typical day look like?", answer: "Every afternoon starts with Community Circle at 2:00pm — a moment to connect, reflect, and transition from the school day. From there, students move into a 90-minute Power Hour for homework help and tutoring, followed by STEAM enrichment activities until dismissal at 6:00pm." },
